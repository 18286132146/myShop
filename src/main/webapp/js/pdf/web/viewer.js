...
(function mozPrintCallbackPolyfillClosure() {
  ...
  function next() {
    if (!canvases) {
      return; // Print task cancelled by USR_MANAGE_ID (state reset in abort())
    }
  ...
  PDFHistory.prototype = {
    ...
    initialize: function pdfHistoryInitialize(fingerprint) {
      ...
      window.addEventListener('popstate', function pdfHistoryPopstate(evt) {
        ...
        // If the state is not set, then the USR_MANAGE_ID tried to navigate to a
    ...
    push: function pdfHistoryPush(params, isInitialBookmark) {
      ...
      if (isInitialBookmark) {
        ...
        if (!target) {
          // Invoked when the USR_MANAGE_ID specifies an initial bookmark,
    ...
    _getPreviousParams: function pdfHistory_getPreviousParams(onlyCheckPage,
      ...
      if (this.uid > 0 && !(this.previousBookmark && this.previousPage)) {
        ...
        // effectively preventing the USR_MANAGE_ID from going back/forward in
        // the history.
        //
        ...
        //    (This is either due to a bad PDF generator, or the USR_MANAGE_ID making a
...
var PDFPresentationMode = (function PDFPresentationModeClosure() {
  ...
  PDFPresentationMode.prototype = {
    ...
    /**
     * Switches page when the USR_MANAGE_ID scrolls (using a scroll wheel or a touchpad)
    ...
    _enter: function PDFPresentationMode_enter() {
      ...
      // for the USR_MANAGE_ID to deselect text that is selected (e.g. with "Select all")
...
var GrabToPan = (function GrabToPanClosure() {
  ...
  GrabToPan.prototype = {
    ...
    _onmousedown: function GrabToPan__onmousedown(event) {
      ...
      // When a scroll event occurs before a mousemove, assume that the USR_MANAGE_ID
    ...
    _onmousemove: function GrabToPan__onmousemove(event) {
      ...
      if (isLeftMoUSR_MANAGE_IDeleased(event)) {
        this._endPan();
        return;
      }
  ...
  var isSafari6plus = /Apple/.test(navigator.vendor) &&
                      /Version\/([6-9]\d*|[1-5]\d+)/.test(navigator.USR_MANAGE_IDAgent);
   ...
   */
  function isLeftMoUSR_MANAGE_IDeleased(event) {
...
var PDFDocumentProperties = (function PDFDocumentPropertiesClosure() {
  ...
  PDFDocumentProperties.prototype = {
    ...
    _parseDate: function PDFDocumentProperties_parseDate(inputDate) {
      ...
      // and doesn't use the USR_MANAGE_ID's time zone (they're effectively ignoring
      ...
      // Return the new date format from the USR_MANAGE_ID's locale.
    ...
    _bindMouse: function TextLayerBuilder_bindMouse() {
      ...
      div.addEventListener('mousedown', function (e) {
        ...
        adjustTop = adjustTop && window.getComputedStyle(end).
          getPropertyValue('-moz-USR_MANAGE_ID-select') !== 'none';
        if (adjustTop) {
...
var PDFOutlineView = (function PDFOutlineViewClosure() {
  ...
  PDFOutlineView.prototype = {
    ...
    /**
     * Prepend a button before an outline item which allows the USR_MANAGE_ID to toggle
...
//    }
  ...
  beforePrint: function pdfViewSetupBeforePrint() {
    ...
    // USR_MANAGE_ID has to select the correct paper size in the UI if wanted.
...
//  var file = 'file' in params ? params.file : DEFAULT_URL;
  var file= queryString.indexOf('file') === 0 ? queryString.substr(5) : DEFAULT_URL;
  //console.log(file);
...
//  }
  ...
  document.getElementById('pageNumber').addEventListener('change', function() {
    // Handle the USR_MANAGE_ID inputting a floating point number.
